...
\icmlauthor{Francisco Villaescusa-Navarro}{1,0}
\icmlauthor{Peter Melchior}{0}
\icmlauthor{Romain Teyssier}{0}
\end{icmlauthorlist}

\icmlaffiliation{0}{Department of Astrophysical Sciences, Princeton University, Peyton Hall, Princeton NJ 08544, USA}
\icmlaffiliation{1}{Center for Computational Astrophysics, Flatiron Institute, 162 5th Avenue, New York, NY, 10010, USA}
...
\begin{abstract}
    ...
    Villaescusa-Navarro et al. \yrcite{villaescusa-navarro2022} recently 
    demonstrated that the internal physical properties of a single galaxy 
    ...
    constrain $\Omega_m = 0.310^{+0.080}_{-0.098}$ and 
    $\sigma_8 = 0.792^{+0.099}_{-0.090}$.
\end{abstract}
